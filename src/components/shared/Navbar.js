...
import {AppBar, Fade, Hidden, InputBase, Zoom} from "@material-ui/core";
                                ...
                                <Grid
                                    ...
                                    <div className={classes.resultWrapper}>
                                        ...
                                        <div className={classes.nameWrapper}>
                                            <Typography
                                                variant={"body1"}>{result.username}                                            </Typography>
        ...
        <div className={classes.linksContainer}>
            ...
            <div className={classes.linksWrapper}>
                ...
                <Link to={`/${defaultCurrentUser.username}`}>
                    <div className={path === `/${defaultCurrentUser}` ? classes.profileActive : ''}>
                    </div>
